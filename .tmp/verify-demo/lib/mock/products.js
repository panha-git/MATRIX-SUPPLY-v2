...
const productSeed = [
    {
        ...
        longDescription: "Sourced from certified growers in Ubon Ratchathani, this AAA jasmine rice is known for its fragrance, fluffy texture, and consistent grain length. Each 50kg woven bag is triple-sealed, palletized, and ready for high-volume food service orders.",
    ...
    },
    {
        ...
        longDescription: "Roasted in small batches and packed in oxygen-absorbing foil liners, this coffee is designed for consistent flavour and smooth extraction. It performs well in espresso bars and ready-to-brew service formats.",
        category: "Food & Beverage",
        subcategory: "Coffee",
        images: [
            "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?auto=format&fit=crop&w=900&q=80",
    ...
    },
    {
        ...
        longDescription: "These 18W LED tubes are built for high-use commercial spaces with long lifecycle components and low heat output. Available in neutral white and daylight variants for showroom and logistics environments.",
...
const extraProducts = Array.from({ length: 137 }, (_, index) => {
