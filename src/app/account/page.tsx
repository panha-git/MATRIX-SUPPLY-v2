        ...
        <div className="container-shell page-pad">
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-[240px_minmax(0,1fr)]">
            <aside className="surface-card h-fit p-3">
              <div className="flex items-center gap-3 rounded-xl bg-primary-soft px-4 py-3 text-sm font-medium text-primary">
                <Icon name="user" size={18} />
                Profile
              </div>
              <Link
                href={destination}
                className="mt-1 flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-muted-ink hover:bg-[#f6f8f7]"
              >
                <Icon
                  name={user.role === "supplier" ? "store" : "grid"}
                  size={18}
                />
                {user.role === "supplier"
                  ? "Supplier dashboard"
            ...
            <section className="surface-card p-6">
              ...
              <p className="mt-2 text-sm text-muted-ink">
                Update the information shown in your local marketplace account.
              </p>
              <form
                onSubmit={submit}
