  ...
  const visible = useMemo(
    () =>
      suppliers.filter((supplier) =>
        `${supplier.businessName} ${supplier.location} ${supplier.description}`
          .toLowerCase()
  ...
  return (
    <>
      <section className="bg-primary-soft py-12">
        <div className="container-shell flex flex-col justify-between gap-7 lg:flex-row lg:items-end">
          <div>
            <p className="text-sm text-muted-ink">
              Marketplace <span className="mx-2">›</span> Suppliers
            </p>
            <h1 className="mt-3 text-4xl font-black tracking-tight">
              Registered suppliers
            </h1>
            <p className="mt-3 max-w-2xl text-muted-ink">
              Every business below is a local supplier account. Counts are
      ...
      <div className="container-shell py-14">
        {visible.length ? (
          ...
          <div className="grid min-h-[320px] place-items-center rounded-2xl border border-dashed border-line text-center">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-ink">
                Supplier business profiles will appear here.
              </p>
            </div>
          </div>
        )}
