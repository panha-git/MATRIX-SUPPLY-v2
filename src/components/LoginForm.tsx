...
const submitButtonClass = [
  ...
  "bg-primary py-3.5 text-sm font-bold text-white",
  ...
  return (
    <div className="w-full max-w-md">
      ...
      <h1 className="mt-4 text-3xl font-black tracking-tight">
        Welcome to MATRIX SUPPLY
      </h1>
      <p className="mt-2 text-sm leading-6 text-muted-ink">
        Enter a Gmail address to open its saved local account or register a new
      ...
      <form onSubmit={submit} className="mt-7" noValidate>
        <label className="text-sm font-semibold">
          ...
          <input
            ...
            onChange={(event) => {
              ...
              setError("");
              inspectAccount(event.target.value);
            }}
        ...
        {knownRole ? (
          <div className="mt-5 rounded-xl border border-primary/20 bg-primary-soft p-4 text-sm text-primary-dark">
            <strong className="capitalize">Welcome back, {knownRole}.</strong>
            <p className="mt-1 text-xs text-muted-ink">
              Your saved profile, role, and account ID will be reused.
            </p>
          </div>
        ) : (
          <>
            <fieldset className="mt-5">
              ...
              <div className="mt-3 grid grid-cols-2 gap-3">
                <RoleButton
                  ...
                  label="Customer"
                  detail="Browse supplier products"
                  onClick={() => {
                    setRole("customer");
                    setError("");
                  }}
                ...
                <RoleButton
                  ...
                  label="Supplier"
                  detail="Post and manage products"
                  onClick={() => {
                    setRole("supplier");
                    setError("");
                  }}
            ...
            {role === "customer" && (
              <div className="mt-5 space-y-4 rounded-2xl border border-line p-4">
                <h2 className="text-sm font-bold">Customer profile</h2>
                <label className="text-sm font-semibold">
                  Full name *
                  <input
                ...
                <OptionalFields details={details} updateDetail={updateDetail} />
              </div>
            )}
              ...
              <div className="mt-5 space-y-4 rounded-2xl border border-line p-4">
                ...
                <label className="text-sm font-semibold">
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      updateDetail("phoneNumber", event.target.value)
                    }
                ...
                <label className="text-sm font-semibold">
                  ...
                  <textarea
                    ...
                    placeholder="What does your business supply?"
                    rows={3}
      ...
      <p className="mt-6 text-center text-[11px] leading-5 text-muted-ink">
        No password, OAuth, API, or database is used. Profiles and products stay
...
function OptionalFields({
  ...
  updateDetail: (name: keyof typeof emptyDetails, value: string) => void;
}) {
  return (
    <>
      <label className="text-sm font-semibold">
      ...
      <label className="text-sm font-semibold">
        Location <span className="font-normal text-muted-ink">(optional)</span>
        <input
          value={details.location}
