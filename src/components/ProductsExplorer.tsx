...
export function ProductsExplorer() {
  ...
  return (
    <div className="container-shell page-pad pb-14">
      <div className="mb-6 rounded-[28px] border border-line bg-white p-4 shadow-[0_8px_30px_rgba(17,43,74,.04)] sm:p-5">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[.16em] text-accent">MATRIX SUPPLY</p>
            <h1 className="mt-1 text-2xl font-black tracking-[-.03em] text-primary">Marketplace feed</h1>
            <p className="mt-1 text-sm text-muted-ink">Browse live wholesale products from verified suppliers across Cambodia.</p>
          </div>
          <div className="rounded-full border border-line bg-slate-50 px-3 py-1.5 text-sm font-semibold text-primary">
