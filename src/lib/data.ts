export const categories = [
  ...
  { name: "Food & Beverage", detail: "Food, drinks & ingredients", icon: "cup" },
  { name: "Clothing", detail: "Apparel & textiles", icon: "sun" },
  { name: "Construction Materials", detail: "Tools & building supplies", icon: "box" },
...
export const productUnits = ["per item", "per kg", "per box", "per pack", "per set", "per litre"] as const;
